...
For language syntax, semantics, and the label/access-mode rules, see the [`write-kestrel`](../.claude/skills/write-kestrel/SKILL.md) skill. This guide layers taste-level idioms on top of that reference.
