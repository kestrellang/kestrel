...
///
/// Enums are sum types with named cases, optional associated values (parameters),
/// and optional generic parameters.
///
/// # Type Resolution
///
...
impl EnumSymbol {
    /// Create a new EnumSymbol with a name, span, visibility, is_indirect flag, and optional parent
    pub fn new(
        name: Name,
        span: Span,
    ...
    /// Check if this enum is marked as indirect
