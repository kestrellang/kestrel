...
pub fn run<A: Analyzer>(analyzer: &mut A, model: &SemanticModel, diagnostics: &mut DiagnosticContext) {
...
pub fn run_all(analyzers: &mut [&mut dyn Analyzer], model: &SemanticModel, ctx: &mut AnalysisContext) {
