...
fn int32_overflow_behavior() {
    Test::new(
        ...
        func main() -> lang.i64 {
            let maxVal = std.num.Int32.maxValue;
            let minVal = std.num.Int32.minValue;
            let one: std.num.Int32 = 1;
            let negOne: std.num.Int32 = -1;
            ...
            let thousand: std.num.Int32 = 1000;
            let fiveHundred: std.num.Int32 = 500;
            let addNormal = thousand.addChecked(fiveHundred);
            if addNormal.isNone() { return 2 }
            let expectedAddNormal: std.num.Int32 = 1500;
            ...
            let expectedNegThousand: std.num.Int32 = -1000;
            ...
            let negFiveHundred: std.num.Int32 = -500;
            ...
            let hundredThousand: std.num.Int32 = 100000;
            ...
            let negBigVal: std.num.Int32 = -2000000000;
            ...
            let expectedNegSatThousand: std.num.Int32 = -1000;
...
fn int32_bitwidth_and_conversion() {
    Test::new(
        ...
        func main() -> lang.i64 {
            ...
            let val: std.num.Int32 = 16909060;
            ...
            let testVal: std.num.Int32 = 123456;
