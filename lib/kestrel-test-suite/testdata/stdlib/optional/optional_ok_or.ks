...
module Test
        ...
        func main() -> lang.i64 {
            ...
            let okResult: std.result.Result[std.numeric.Int64, std.numeric.Int64] = some.okOr( 99);
            ...
            let okResult2: std.result.Result[std.numeric.Int64, std.numeric.Int64] = some.okOrElse({ () in 99 });
