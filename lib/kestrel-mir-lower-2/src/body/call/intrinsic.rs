...
static TABLE: &[IntrinsicEntry] = &[
    ...
    IntrinsicEntry { name: "cast_unsigned_i8_i16", op: Op::IntUnsignedWiden(IntBits::I8, IntBits::I16), arity: 1 },
    IntrinsicEntry { name: "cast_unsigned_i8_i32", op: Op::IntUnsignedWiden(IntBits::I8, IntBits::I32), arity: 1 },
    IntrinsicEntry { name: "cast_unsigned_i8_i64", op: Op::IntUnsignedWiden(IntBits::I8, IntBits::I64), arity: 1 },
    IntrinsicEntry { name: "cast_unsigned_i16_i32", op: Op::IntUnsignedWiden(IntBits::I16, IntBits::I32), arity: 1 },
    IntrinsicEntry { name: "cast_unsigned_i16_i64", op: Op::IntUnsignedWiden(IntBits::I16, IntBits::I64), arity: 1 },
    IntrinsicEntry { name: "cast_unsigned_i32_i64", op: Op::IntUnsignedWiden(IntBits::I32, IntBits::I64), arity: 1 },
    // Float arithmetic
