...
use kestrel_mir_2::{MonoFunction, MonoModule, ParamConvention, TyArena};
...
/// Borrow and MutBorrow always pass by pointer.
/// Consuming dispatches on TypeRepr.
...
/// Determine how a function returns its value.
...
/// Build a Cranelift Signature for a MonoFunction.
pub fn build_signature(
    ...
    // Sret: hidden first parameter (pointer to return slot)
...
/// Build a Cranelift Signature for an extern (C ABI) function.
pub fn build_extern_signature(
    ...
    // Extern: sret for aggregate returns
