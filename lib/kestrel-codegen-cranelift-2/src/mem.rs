...
/// Multi-stride memory copy (8/4/2/1 bytes).
...
/// Multi-stride memory zeroing (8/4/2/1 bytes).
...
/// Store a value to an address, dispatching on TypeRepr.
...
/// Load a value from an address, dispatching on TypeRepr.
/// Scalars: load the value. Aggregates: return the address itself. Zst: return zero.
