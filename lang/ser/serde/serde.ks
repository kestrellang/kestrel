...
public protocol Serializer {
    ...
    mutating func serializeNil() -> Result[(), Error]
    mutating func serializeBool(value: Bool) -> Result[(), Error]
    mutating func serializeInt(value: Int) -> Result[(), Error]
    mutating func serializeInt8(value: Int8) -> Result[(), Error]
    mutating func serializeInt16(value: Int16) -> Result[(), Error]
    mutating func serializeInt32(value: Int32) -> Result[(), Error]
    mutating func serializeInt64(value: Int64) -> Result[(), Error]
    mutating func serializeUInt(value: UInt) -> Result[(), Error]
    mutating func serializeUInt8(value: UInt8) -> Result[(), Error]
    mutating func serializeUInt16(value: UInt16) -> Result[(), Error]
    mutating func serializeUInt32(value: UInt32) -> Result[(), Error]
    mutating func serializeUInt64(value: UInt64) -> Result[(), Error]
    mutating func serializeFloat32(value: Float32) -> Result[(), Error]
    mutating func serializeFloat64(value: Float64) -> Result[(), Error]
    mutating func serializeString(value: String) -> Result[(), Error]

    // Compound types
    mutating func serializeArray[S](values: Array[S]) -> Result[(), Error] where S: Serialize
    mutating func serializeMap[K, V](entries: Array[(K, V)]) -> Result[(), Error] where K: Serialize, V: Serialize

    // Struct/object serialization
    mutating func beginObject(name: String, fieldCount: Int) -> Result[ObjectSerializer, Error]
    mutating func beginArray(length: Int) -> Result[ArraySerializer, Error]

    // Get the final output
    mutating func finish() -> Result[Output, Error]
}
...
public protocol ObjectSerializer {
    ...
    mutating func serializeField[V](name: String, value: V) -> Result[(), Error] where V: Serialize
    mutating func end() -> Result[(), Error]
}
...
public protocol ArraySerializer {
    ...
    mutating func serializeElement[V](value: V) -> Result[(), Error] where V: Serialize
    mutating func end() -> Result[(), Error]
}
...
public protocol Deserializer {
    ...
    mutating func deserializeNil() -> Result[Nil, Error]
    mutating func deserializeBool() -> Result[Bool, Error]
    mutating func deserializeInt() -> Result[Int, Error]
    mutating func deserializeInt8() -> Result[Int8, Error]
    mutating func deserializeInt16() -> Result[Int16, Error]
    mutating func deserializeInt32() -> Result[Int32, Error]
    mutating func deserializeInt64() -> Result[Int64, Error]
    mutating func deserializeUInt() -> Result[UInt, Error]
    mutating func deserializeUInt8() -> Result[UInt8, Error]
    mutating func deserializeUInt16() -> Result[UInt16, Error]
    mutating func deserializeUInt32() -> Result[UInt32, Error]
    mutating func deserializeUInt64() -> Result[UInt64, Error]
    mutating func deserializeFloat32() -> Result[Float32, Error]
    mutating func deserializeFloat64() -> Result[Float64, Error]
    mutating func deserializeString() -> Result[String, Error]

    // Compound types
    mutating func deserializeArray[T]() -> Result[Array[T], Error] where T: Deserialize
    mutating func deserializeMap[K, V]() -> Result[Dictionary[K, V], Error] where K: Deserialize, K: Hashable, V: Deserialize

    // Struct/object deserialization
    mutating func deserializeObject[V](visitor: V.Visitor) -> Result[V, Error] where V: Deserialize
}
...
//     type Value = Point
//
//     public mutating func visit[A](mutating access: A) where A: ObjectAccess -> Result[Point, A.Error] {
...
public protocol ObjectVisitor {
    ...
    mutating func visit[A](mutating access: A) -> Result[Value, A.Error] where A: ObjectAccess
}
...
public protocol ObjectAccess {
    ...
    mutating func nextField() -> Result[Optional[String], Error]
    mutating func value[V]() -> Result[V, Error] where V: Deserialize
    mutating func skipValue() -> Result[(), Error]
}
...
public protocol ArrayAccess {
    ...
    mutating func next[V]() -> Result[V, Error] where V: Deserialize
}
...
public struct BoolVisitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Bool, A.Error] where A: ObjectAccess {
...
public struct IntVisitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Int, A.Error] where A: ObjectAccess {
...
public struct Int8Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Int8, A.Error] where A: ObjectAccess {
...
public struct Int16Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Int16, A.Error] where A: ObjectAccess {
...
public struct Int32Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Int32, A.Error] where A: ObjectAccess {
...
public struct Int64Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Int64, A.Error] where A: ObjectAccess {
...
public struct UIntVisitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[UInt, A.Error] where A: ObjectAccess {
...
public struct UInt8Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[UInt8, A.Error] where A: ObjectAccess {
...
public struct UInt16Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[UInt16, A.Error] where A: ObjectAccess {
...
public struct UInt32Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[UInt32, A.Error] where A: ObjectAccess {
...
public struct UInt64Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[UInt64, A.Error] where A: ObjectAccess {
...
public struct Float32Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Float32, A.Error] where A: ObjectAccess {
...
public struct Float64Visitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Float64, A.Error] where A: ObjectAccess {
...
public struct StringVisitor: ObjectVisitor {
    ...
    public mutating func visit[A](mutating access: A) -> Result[String, A.Error] where A: ObjectAccess {
...
public struct OptionalVisitor[T]: ObjectVisitor where T: Deserialize {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Optional[T], A.Error] where A: ObjectAccess {
...
public struct ArrayVisitor[T]: ObjectVisitor where T: Deserialize {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Array[T], A.Error] where A: ObjectAccess {
...
public struct DictionaryVisitor[K, V]: ObjectVisitor where K: Deserialize, K: Hashable, V: Deserialize {
    ...
    public mutating func visit[A](mutating access: A) -> Result[Dictionary[K, V], A.Error] where A: ObjectAccess {
