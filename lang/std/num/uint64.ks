    ...
    Convertible[UInt32]
{
    ...
    public var leadingZeros: Int64 { get {
        ...
        var i: Int64 = 64 - 1;
        while i >= 0 {
            let bit = lang.i64_and(lang.i64_unsigned_shr(n, i.raw), 1);
    ...
    public var byteSwapped: UInt64 { get {
        ...
        let b1 = lang.i64_and(lang.i64_unsigned_shr(self.raw, 8), 255);
        let b2 = lang.i64_and(lang.i64_unsigned_shr(self.raw, 16), 255);
        let b3 = lang.i64_and(lang.i64_unsigned_shr(self.raw, 24), 255);
        let b4 = lang.i64_and(lang.i64_unsigned_shr(self.raw, 32), 255);
        let b5 = lang.i64_and(lang.i64_unsigned_shr(self.raw, 40), 255);
        let b6 = lang.i64_and(lang.i64_unsigned_shr(self.raw, 48), 255);
        let b7 = lang.i64_and(lang.i64_unsigned_shr(self.raw, 56), 255);
        UInt64(raw: lang.i64_or(lang.i64_or(lang.i64_or(lang.i64_or(lang.i64_or(lang.i64_or(lang.i64_or(
            lang.i64_shl(b0, 56),
            lang.i64_shl(b1, 48)),
            lang.i64_shl(b2, 40)),
            lang.i64_shl(b3, 32)),
