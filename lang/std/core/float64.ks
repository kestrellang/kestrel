    ...
    FFISafe
{
    ...
    public func pow(exponent: Float64) -> Float64 { Float64.zero }
    public func sin() -> Float64 { Float64.zero }
    public func cos() -> Float64 { Float64.zero }
    public func tan() -> Float64 { Float64.zero }
    public func asin() -> Float64 { Float64.zero }
    public func acos() -> Float64 { Float64.zero }
    public func atan() -> Float64 { Float64.zero }
    public func atan2(x: Float64) -> Float64 { Float64.zero }
    public func exp() -> Float64 { Float64.zero }
    public func ln() -> Float64 { Float64.zero }
    public func log10() -> Float64 { Float64.zero }
    public func log2() -> Float64 { Float64.zero }
}
