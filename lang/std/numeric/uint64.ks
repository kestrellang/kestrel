    ...
    Convertible[UInt32]
{
    ...
    public func shiftLeft(by count: Int64) -> UInt64 { UInt64(raw: lang.i64_shl(self.raw, count.raw)) }
    ...
    /// `shiftLeft`.
    public func shiftRight(by count: Int64) -> UInt64 { UInt64(raw: lang.i64_unsigned_shr(self.raw, count.raw)) }
