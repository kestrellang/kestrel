    ...
    Convertible[UInt64]
{
    ...
    public static var zero: UInt8 { 0 }
    ...
    /// This is 2^8 - 1 (255).
    public static var maxValue: UInt8 { 255 }
    ...
    /// 42 == 42;               // true
    /// ```
    public func isEqual(to other: UInt8) -> Bool {
    ...
    public func hash[H](mutating into hasher: H) where H: Hasher {
        let val = self;
        hasher.write(ArraySlice(pointer: Pointer(to: val).asRaw().cast[UInt8](), count: Layout.of[UInt8]().size))
    }
    ...
    type RangeConstructible.Output = Range[UInt8]
    type ClosedRangeConstructible.Output = ClosedRange[UInt8]
    type RangeFromConstructible.Output = RangeFrom[UInt8]
    type RangeUpToConstructible.Output = RangeUpTo[UInt8]
    type RangeThroughConstructible.Output = RangeThrough[UInt8]
    ...
    public consuming func add(consuming other: UInt8) -> UInt8 { UInt8(raw: lang.i8_add(self.raw, other.raw)) }

    /// `self - other`, wrapping on overflow.
    public consuming func subtract(consuming other: UInt8) -> UInt8 { UInt8(raw: lang.i8_sub(self.raw, other.raw)) }

    /// `self * other`, wrapping on overflow.
    public consuming func multiply(consuming other: UInt8) -> UInt8 { UInt8(raw: lang.i8_mul(self.raw, other.raw)) }
    ...
    public consuming func divide(consuming other: UInt8) -> UInt8 { UInt8(raw: lang.i8_unsigned_div(self.raw, other.raw)) }
    ...
    public consuming func bitwiseAnd(consuming other: UInt8) -> UInt8 { UInt8(raw: lang.i8_and(self.raw, other.raw)) }

    /// Bitwise OR. `0b1010 | 0b1100 == 0b1110`.
    public consuming func bitwiseOr(consuming other: UInt8) -> UInt8 { UInt8(raw: lang.i8_or(self.raw, other.raw)) }

    /// Bitwise XOR. `0b1010 ^ 0b1100 == 0b0110`.
    public consuming func bitwiseXor(consuming other: UInt8) -> UInt8 { UInt8(raw: lang.i8_xor(self.raw, other.raw)) }

    /// Bitwise NOT — flips all bits. For signed types this is `-self - 1`.
    public consuming func bitwiseNot() -> UInt8 { UInt8(raw: lang.i8_not(self.raw)) }

    /// Left shift by `count`. Behavior is undefined when `count >= bitWidth`
    /// — pre-mask the count if you can't guarantee the bound.
    public consuming func shiftLeft(consuming by count: Int64) -> UInt8 { UInt8(raw: lang.i8_shl(self.raw, lang.cast_i64_i8(count.raw))) }
    ...
    /// `shiftLeft`.
    public consuming func shiftRight(consuming by count: Int64) -> UInt8 { UInt8(raw: lang.i8_unsigned_shr(self.raw, lang.cast_i64_i8(count.raw))) }
    ...
    public init[S](fromBytesBigEndian fromBytesBigEndian: S)? where S: Slice[UInt8] {
        ...
        self.raw = UInt8(from: result).raw;
    }
