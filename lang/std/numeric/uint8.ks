    ...
    Convertible[UInt64]
{
    ...
    public func shiftLeft(by count: Int64) -> UInt8 { UInt8(raw: lang.i8_shl(self.raw, lang.cast_i64_i8(count.raw))) }
    ...
    /// `shiftLeft`.
    public func shiftRight(by count: Int64) -> UInt8 { UInt8(raw: lang.i8_unsigned_shr(self.raw, lang.cast_i64_i8(count.raw))) }
    ...
    public static func fromBytes(bytes: std.collections.Array[UInt8]) -> UInt8? {
        if bytes.count != 1 {
            return .None
        }
    ...
    public static func fromBytesBigEndian(bytes: std.collections.Array[UInt8]) -> UInt8? {
        if bytes.count != 1 {
            return .None
        }
        var result: UInt64 = 0;
        ...
        .Some(UInt8(from: result))
    }

    /// Reassembles a `UInt8` from 1 bytes in little-endian order.
    /// Returns `None` if the input is not exactly 1 bytes long.
    public static func fromBytesLittleEndian(bytes: std.collections.Array[UInt8]) -> UInt8? {
        if bytes.count != 1 {
            return .None
        }
        var result: UInt64 = 0;
