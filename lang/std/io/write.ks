...
/// ```
public func writeAll(mutating writer: some Writable, from buf: ArraySlice[UInt8]) -> Result[(), IoError] {
    var written: Int64 = 0;
...
public func writeByte(mutating writer: some Writable, byte: UInt8) -> Result[(), IoError] {
...
/// first).
public func writeString(mutating writer: some Writable, s: String) -> Result[(), IoError] {
...
public func writeLine(mutating writer: some Writable, s: String) -> Result[(), IoError] {
